            ...
            <hr class="mb-4"> {{-- garis panjang --}}
                    <div class="app-card app-card-settings shadow-sm p-3">
                        <div class="app-card-body">
                            <form class="settings-form" enctype="multipart/form-data" method="post" action="{{ url('lihatnilai/update/'.$data->id)}}">
                                @csrf
                                @method('put')
                                ...
                                <div class="mb-1"> {{-- jarak antara form 1 dan tulisan contact name --}}
                                 ...
                                 <div class="mb-1"> {{--jarak antara form 1 dan tulisan contact name --}}
                                    ...
                                    <input type="text" class="form-control @error('nilai_tes_mtk') is-invalid @enderror" id="mtk" name="nilai_tes_mtk" value="{{ $data->nilai_tes_mtk }}" >
                                    @error('nilai_tes_mtk')
                                        <div class="invalid-feedback">
                                                {{ $message }}
                                        </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control @error('nilai_tes_ipa') is-invalid @enderror" id="ipa" name="nilai_tes_ipa" value="{{ $data->nilai_tes_ipa }}" >
                                    @error('nilai_tes_ipa')
                                        <div class="invalid-feedback">
                                                {{ $message }}
                                        </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control @error('nilai_tes_agama') is-invalid @enderror" id="agama" name="nilai_tes_agama" value="{{ $data->nilai_tes_agama }}" >
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control @error('nilai_tes_bindo') is-invalid @enderror" id="bindo" name="nilai_tes_bindo" value="{{ $data->nilai_tes_bindo }}" >
